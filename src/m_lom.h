...
#define F_LM_CPRG                       ((uint32_t)1 << 1)
#define F_LM_LOM                        ((uint32_t)1 << 2)

#define F_LM_TYPES                      (F_LM_CPRG|F_LM_LOM)

#define F_LOM_INT                       ((uint32_t)1 << 1)
#define F_LOM_INT_S                     ((uint32_t)1 << 2)
#define F_LOM_FLOAT                     ((uint32_t)1 << 3)
#define F_LOM_LVAR_KNOWN                ((uint32_t)1 << 4)
#define F_LOM_RVAR_KNOWN                ((uint32_t)1 << 5)
#define F_LOM_HASOPER                   ((uint32_t)1 << 6)
#define F_LOM_FLOAT_DBL                 ((uint32_t)1 << 7)
#define F_LOM_IS_LVAR_MATH              ((uint32_t)1 << 8)
#define F_LOM_IS_RVAR_MATH              ((uint32_t)1 << 9)

#define F_LOM_TYPES                     (F_LOM_FLOAT|F_LOM_INT|F_LOM_INT_S)
#define F_LOM_VAR_KNOWN                 (F_LOM_LVAR_KNOWN|F_LOM_RVAR_KNOWN)

#define F_GLT_LEFT                      ((uint32_t)1 << 1)
#define F_GLT_RIGHT                     ((uint32_t)1 << 2)

#define F_GLT_DIRECT                    (F_GLT_LEFT|F_GLT_RIGHT)

#define MAX_LOM_STRING                  4096

#define F_GH_HASLOM                     ((uint64_t)1 << 24)
