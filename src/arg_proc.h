...
#define F_PARSE_ARG_IGNORE_ERRORS      ((uint32_t)1 << 1)
#define F_PARSE_ARG_SILENT             ((uint32_t)1 << 2)
#define F_PARSE_ARG_IGNORE_NOT_FOUND   ((uint32_t)1 << 3)
#define F_PARSE_ARG_BREAK_NOT_FOUND    ((uint32_t)1 << 4)
